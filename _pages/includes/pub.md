...
- `CIKM 2026` [GrAP³: A Data-free Model Extraction Attack Framework under Graph Pre-training and Prompt Learning Paradigm](pub/GrAP_CIKM2026.pdf), Lingxiang Tian, **Yang Liu**, Xingtong Yu, Zhuoer Xu and Xiang Ao.
- `WWW 2026` [A2GBD: Attack-Agnostic Graph Backdoor Defense](pub/A2GBD_WWW2026.pdf), Chenxu Du, **Yang Liu**, Xingtong Yu, Zhuoer Xu, Yang Liu, Tianrui Li.
- `WWW 2026` [Robust Graph Learning on the Web: Challenges, Methods, and Applications](pub/Tu_WWW2026.pdf), Xiang Ao, **Yang Liu**, Guansong Pang, Yuanhao Ding, Hezhe Qiao, Dawei Cheng, and Qing He.
...
- ``DASFAA 2025`` [OFTEN: Graph Invariant Learning via Soft Environment Inference](pub/OFTEN_DASFAA2025.pdf), **Yang Liu**, Zikun Zhang, Xiang Ao, Lingxiang Tian, Qing He.
...
- ``ICLR 2024`` [Boosting the Adversarial Robustness of Graph Neural Networks: An OOD Perspective](pub/GOODAT_ICLR2024.pdf), [Kuan Li](https://likuanppd.github.io/), Yiwen Chen, **Yang Liu**, Jin Wang, Qing He, Minhao Cheng and Xiang Ao. [![](https://img.shields.io/github/stars/likuanppd/GOOD-AT?style=social&label=Code+Stars)](https://github.com/likuanppd/GOOD-AT)
- `ICLR 2023` [Revisiting Graph Adversarial Attack and Defense From a Data Distribution Perspective](pub/Revisiting_ICLR2023.pdf), [Kuan Li](https://likuanppd.github.io/), **Yang Liu**, Xiang Ao, Qing He. 
